 ...
 * as an {@link javafx.util.converter.LongStringConverter} instance.
 *
 * @since JavaFX 8u40
 */
public class LongSpinnerValueFactory extends SpinnerValueFactory<Long> {
	...
	/**
	 * Constructs a new LongSpinnerValueFactory that sets the initial value to
	 * be equal to the min value, and a default {@code amountToStepBy} of one.
	 *
	 * @param min
	 *            The minimum allowed long value for the Spinner.
	 * @param max
	 *            The maximum allowed long value for the Spinner.
	 */
