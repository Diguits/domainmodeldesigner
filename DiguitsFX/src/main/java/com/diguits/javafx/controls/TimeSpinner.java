...
public class TimeSpinner extends Spinner<LocalTime> {
	...
	public TimeSpinner(LocalTime time) {
		 ...
		 * TextFormatter<LocalTime>(localTimeConverter, null, c -> { String
		 * newText = c.getControlNewText(); if(newText == null){ newText="";
		 * c.setText(""); } if (newText=="" ||
		 * newText.matches("[0-9]{0,2}:[0-9]{0,2}:[0-9]{0,2}")) { return c ; }
		 * return null ; });
		 */
