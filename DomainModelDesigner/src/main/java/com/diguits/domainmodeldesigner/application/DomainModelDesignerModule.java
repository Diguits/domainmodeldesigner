...
import com.diguits.domainmodeldefinition.serialization.services.SimpleXMLEntityDefinitionSerializer;
...
public class DomainModelDesignerModule extends AbstractModule {
	...
	protected void configure() {
		bind(IEntityDefinitionSerializer.class).to(SimpleXMLEntityDefinitionSerializer.class);
